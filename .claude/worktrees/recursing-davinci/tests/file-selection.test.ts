...
describe('File Selection Integration', () => {
  ...
  describe('Error Handling in File Selection', () => {
    ...
    it('should handle dialog errors and provide meaningful feedback', async () => {
      ...
      await expect(mockEnhancedFileBrowser.selectSingleFile()).rejects.toThrow(
        'Unable to open file selection dialog. Please try again or restart the application.'
      );
    });
  });
